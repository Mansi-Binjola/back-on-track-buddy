// chrome.storage.sync.get(["blockLinks",'trackingStarted'],function(value){
//     console.log(value.trackingStarted);
...
//         } else {
//             message['valid'] = false;
//             message['message'] = "The link entered is already in the list.";
//             message['title'] = "Duplicate Link";
//         }
//     } else {
//         message['valid'] = false;
//         message['message'] = "The link entered is not of correct format, please enter correct link.";
